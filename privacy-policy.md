...
- **Export your data**: not currently supported in v1.0 — email feedback@rise-app.com to request.
- **GDPR, CCPA, PIPEDA, LGPD, KVKK**: residents of those jurisdictions can request access, correction, or erasure by emailing privacy@rise-app.com. We respond within 30 days.

## 5. Children

Rise is rated 4+ but is not directed at children under 13. We do not knowingly collect data from children. If you believe a child has provided data, email privacy@rise-app.com and we will delete it.
